    ...
    return(
        <div className="container-fluid py-sm-4 py-md-4 py-lg-4">
            ...
            <div className="w-100 bg-white shadow rounded-3 mt-5">
                <h4 className="px-4 pt-4 mx-2 pb-3">Add Category</h4>
                <hr className="hr" />
                <div className="p-4 pt-3 mx-2">
                    <div className="form-group">
                        <h5 htmlFor="imageInput" className="pb-2">Image</h5>
                        <input type="file" className="form-control form-control-lg" id="imageInput" aria-describedby="imageHelp" placeholder="Select image" />
                    ...
                    <div className="form-group mt-3">
                        ...
                        <input type="text" className="form-control form-control-lg " id="categoryName" aria-describedby="categoryHelp" placeholder="Enter Category Name" />
